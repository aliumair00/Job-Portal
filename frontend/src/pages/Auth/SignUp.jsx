      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-600">
            Join thousand of professionals finding their dream jobs
          </p>
        </div>
          ...
          <div className="">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className={`p-4 rounded-lg border-2 transistion-all 
                ${
              ...
              >
                ...
                <div className="font-medium text-center">Job Seeker</div>
              ...
              >
                ...
                <div className="font-medium text-center">Employer</div>
