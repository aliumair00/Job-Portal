      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 ">
            ...
            <span
              className="block bg-linear-to-r from-blue-600
          ...
          <p className="text-xl text-gray-900 max-w-3xl mx-auto">
            Whether you're looking for four next opportunity or the perfect
            canidate, we have the tools and features to make it happen.
          </p>
        </div>
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              {employerFeatures.map((feature, index) => (
                <div
                  key={index}
                  className="group flex items-start space-x-4 p-6 rounded-2xl hover:bg-purple-200 transition-all duration-300 cursor-pointer"
                >
